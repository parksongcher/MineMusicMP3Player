...
//implements View.OnClickListener를 왜 썼을까? 이벤트 처리 할게 많을때 매우 유용하게 쓰임
public class Player extends Fragment implements View.OnClickListener{
    ...
    //프래그먼트에서 장차된 액티비티를 가져올수 있다. getActivity()
    //노래를 등록하기 위해서 선언 객체 변수
    ...
    //좋아요 리스트만 가져왔을까, MusicAdapter ?
    private ArrayList<MusicData> likeArrayList = new ArrayList<>();
//  private MusicAdapter musicAdapter;

    //Context = (화면 + 컨트롤러 클래스)를 합친것을 Context라 한다.
    @Override
